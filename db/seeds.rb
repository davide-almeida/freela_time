...
User.create!(first_name: "Davide User", email: "user@user.com.br", password: "123456", password_confirmation: "123456")
...
Task.create!(name: "Task 1", project_id: 1, status: 0, user_id: 1, company_id: 1)
#Task.create!(name: "Task 2", project_id: 1, status: 0, user_id: 1, company_id: 1)
#Task.create!(name: "Task 3", project_id: 2, status: 0, user_id: 1, company_id: 2)

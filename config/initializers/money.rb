# encoding : utf-8
Money.locale_backend = :currency #Remove deprecated warning
...
MoneyRails.configure do |config|
  ...
  config.no_cents_if_whole = false #definindo para exibir as casas decimais quando os centavos forem zero
